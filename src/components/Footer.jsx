    ...
    return (
        <footer className="main-footer">
            <div className="footer-content container">
                ...
                <div className="left-section">
                    ...
                    <div className="footer-section about">
                        <h4>Hazır Yemek</h4>
                        <p>En taze malzemelerle hazırlanan lezzetler. Sipariş ve rezervasyon için bize ulaşın.</p>
                        <p>Adres: Gaziosmanpaşa, Sahil Cd., No 13 Gölbaşı/Ankara</p>
                        <p>Telefon: (530) 013 05 25</p>
                    </div>
                    ...
                    <div className="footer-section social-media">
                        ...
                        <div className="social-icons">
                            ...
                            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className='x'><RiTwitterXFill />    Twitter</a>
                        </div>
            ...
            <div className="footer-bottom">
                &copy; 2025 HAZIR YEMEK. Tüm Hakları Saklıdır.
            </div>
        </footer>
    );
};
